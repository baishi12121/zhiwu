package com.hyf.malladminservice.config;
...
/**
 * Product search index MQ topology declared by the publisher too, so events are
 * queued even when the search service is temporarily offline.
 */
@Configuration
